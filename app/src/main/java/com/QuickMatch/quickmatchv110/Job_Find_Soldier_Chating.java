...
public class Job_Find_Soldier_Chating extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.job_find_soldier_chating);
            ...
            if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.SEND_SMS)){
                ...
                builder.setNeutralButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //권한 요청
                        ActivityCompat.requestPermissions(Job_Find_Soldier_Chating.this, new String[] {Manifest.permission.SEND_SMS}, MY_PERMISSION_REQUEST_SMS);
                    }
                });
        ...
        job_send_phoneNum = findViewById(R.id.find_soldier_chating_phoneNum);
        job_send_contents = findViewById(R.id.find_soldier_chating_contents);
        job_send_message = findViewById(R.id.find_soldier_chating_send);

        job_send_phoneNum.setText(getIntent.getStringExtra(Job_F_Soldier_Info.jobfindSoldier));  // 게시글의 전화번호를 전달받아 자동으로 입력
