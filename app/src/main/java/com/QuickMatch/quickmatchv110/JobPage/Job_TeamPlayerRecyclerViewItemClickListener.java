...
public class Job_TeamPlayerRecyclerViewItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public Job_TeamPlayerRecyclerViewItemClickListener(Context context, final RecyclerView recyclerView, final Job_TeamPlayerRecyclerViewItemClickListener.OnItemClickListener listener ){
