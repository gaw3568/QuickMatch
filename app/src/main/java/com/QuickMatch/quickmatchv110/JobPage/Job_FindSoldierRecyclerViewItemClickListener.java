...
public class Job_FindSoldierRecyclerViewItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public Job_FindSoldierRecyclerViewItemClickListener(Context context, final RecyclerView recyclerView, final Job_FindSoldierRecyclerViewItemClickListener.OnItemClickListener listener ){
