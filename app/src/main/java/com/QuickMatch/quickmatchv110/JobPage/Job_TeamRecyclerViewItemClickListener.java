...
public class Job_TeamRecyclerViewItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public Job_TeamRecyclerViewItemClickListener(Context context, final RecyclerView recyclerView, final Job_TeamRecyclerViewItemClickListener.OnItemClickListener listener ){
