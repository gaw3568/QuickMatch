...
public class TeamRecyclerViewItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public TeamRecyclerViewItemClickListener(Context context, final RecyclerView recyclerView, final OnItemClickListener listener ){
